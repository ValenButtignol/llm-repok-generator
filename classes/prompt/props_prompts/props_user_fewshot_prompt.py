...
from classes.prompt.templates import CLASS_EXAMPLE_1, CLASS_EXAMPLE_2, CLASS_NAME_EXAMPLE_1, CLASS_NAME_EXAMPLE_2, CODE_PROP_BASIC_PROMPT, CODE_PROP_END_OF_PROMPT, CODE_PROP_USER_TASK, CODE_SINGLE_PROP_EXAMPLE_1, CODE_SINGLE_PROP_EXAMPLE_2, SYSTEM_PROMPT, TEXT_PROP_BASIC_PROMPT, TEXT_PROP_END_OF_PROMPT, TEXT_PROP_LIST_EXAMPLE_1, TEXT_PROP_LIST_EXAMPLE_2, TEXT_PROP_USER_TASK, TEXT_SINGLE_PROP_EXAMPLE_1, TEXT_SINGLE_PROP_EXAMPLE_2
...
class CodePropUserFewShotPrompt(JsonPrompt):
