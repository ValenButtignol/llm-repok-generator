...
from classes.prompt.template_prompts.templates import SYSTEM_PROMPT_PROP_LIST, SYSTEM_PROMPT_REPOK_AND_PROP, CLASS_EXAMPLE_1, TEXT_PROP_LIST_EXAMPLE_1, CODE_SINGLE_PROP_EXAMPLE_1, CLASS_EXAMPLE_2, TEXT_PROP_LIST_EXAMPLE_2, CODE_SINGLE_PROP_EXAMPLE_2
...
class DualRepOkFewShotCoTWholeClassPrompt(JsonPrompt):
    def __init__(self, classwithprop):
        ...
        self.add_user_message(CLASS_EXAMPLE_1 + TEXT_PROP_LIST_EXAMPLE_1)
        self.add_assistant_message(CODE_SINGLE_PROP_EXAMPLE_1)

        self.add_user_message(CLASS_EXAMPLE_2 + TEXT_PROP_LIST_EXAMPLE_2)
