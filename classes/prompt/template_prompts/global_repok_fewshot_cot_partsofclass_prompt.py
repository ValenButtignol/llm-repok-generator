...
from classes.prompt.template_prompts.templates import SYSTEM_PROMPT_REPOK, USER_PROMPT_PROP_LIST, USER_PROMPT_CHAIN_OF_THOUGT, PARTS_OF_CLASS_1, TEXT_PROP_LIST_EXAMPLE_1, REPOK_EXAMPLE_1, PARTS_OF_CLASS_2, TEXT_PROP_LIST_EXAMPLE_2, REPOK_EXAMPLE_2
