...
#         ]
    ...
    def basic_prompt(self):
        ...
        prompt.add_user_message("### Your task is to write representation invariants for Java classes. Answer by giving the representation invariant as a Java method called `repOK`. Don't provide explanations.\n### Write a representation invariant for the LinkedList class.\n" + CLASS_EXAMPLE_3.replace("[Class]\n","") + "\n### repOK:\n")
    ...
    def basic_system(self):
        ...
        prompt.add_system_message("### You are an expert software engineer with proficiency in the Java programming language. Your task is to write representation invariants for Java classes. Answer by giving the representation invariant as a Java method called `repOK`. Don't provide explanations.")
    ...
    def system_hints(self):
        ...
        prompt.add_system_message("### You are an expert software engineer with proficiency in the Java programming language. Your task is to write representation invariants for Java classes.\n### Take into account the following rules for writing the representation invariant:\n- The representation invariant is a boolean method of the class.\n- The representation invariant must return `true` if the object is valid, and `false` otherwise.\n- Answer by giving the representation invariant as a Java method called `repOK`.\n- Only verify properties in the representation invariant that you are completely sure are valid.\n- Don't provide explanations.\n")
        prompt.add_user_message("### Write a representation invariant for the LinkedList class.\n" + CLASS_EXAMPLE_3.replace("[Class]\n","") + "\n### repOK:\n")
    ...
    def codeprops_basic_prompt(self):
        ...
        prompt.add_system_message("### You are an expert software engineer with proficiency in the Java programming language.")
        prompt.add_user_message("### Your task is to provide the code for a property of the representation invariant for Java classes. Answer by giving the property as a Java method called `property`. Don't provide explanations.\n### Write the property of the representation invariant for the LinkedList class.\n" + CLASS_EXAMPLE_3.replace("[Class]\n","") + "\n### Property:\n" + TEXT_SINGLE_PROP_EXAMPLE_3.replace("[Property]\n", "") + "\n### Code Property:")
    ...
    def codeprops_basic_system(self):
        ...
        prompt.add_system_message("### You are an expert software engineer with proficiency in the Java programming language. Your task is to provide the code for a property of the representation invariant for Java classes. Answer by giving the property as a Java method called `property`. Don't provide explanations.")
    ...
    def codeprops_system_hints(self):
        ...
        prompt.add_system_message("### You are an expert software engineer with proficiency in the Java programming language. Your task is to provide the code for a property of the representation invariant for Java classes.\n### Take into account the following rules for writing the property:\n- The property is a boolean method of the class.\n- The property must return `true` if the object satisfies the property, and `false` otherwise.\n- Answer by giving the property as a Java method called `property`.\n- Don't provide explanations.\n")
        prompt.add_user_message("### Write the property of the representation invariant for the LinkedList class.\n" + CLASS_EXAMPLE_3.replace("[Class]\n","") + "\n### Property:\n" + TEXT_SINGLE_PROP_EXAMPLE_3.replace("[Property]\n", "") + "\n### Code Property:")
